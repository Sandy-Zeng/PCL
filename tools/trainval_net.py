...
# from model.train_val_classify import get_training_roidb, train_net
...
def parse_args():
  ...
  parser.add_argument('--loadfc', help='load fc', default=0,
                      type=int)
...
if __name__ == '__main__':
  ...
  if args.net == 'vgg16':
    ...
    net = resnet_fusion(batch_size=cfg.TRAIN.IMS_PER_BATCH, num_layers=50)
  ...
  train_net(net, args.net, imdb, roidb, valroidb, output_dir, tb_dir,
            pretrained_model=args.weight,
            max_iters=args.max_iters,
            loadfc=args.loadfc, imdb_name=args.imdb_name)

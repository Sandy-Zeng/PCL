...
from nets.network_constrained import Network
...
class resnet_constrained(Network):
  ...
  def build_network(self, sess, is_training=True):
    ...
    # with tf.variable_scope('noise_pred'):  
    #   # fc7 = tf.concat(3, [fc7, noise_fc7])
    #   # fc7=tf.Print(fc7,[tf.shape(fc7)],message='Value of %s' % 'fc', summarize=4, first_n=1)
    #   # channel_attention, spatial_attention = self.cbam_module(fc7, kernel=3)
    #   # fc7 = fc7 * channel_attention * spatial_attention

    #   cls_fc7 = tf.reduce_mean(noise_fc7, axis=[1, 2])

...
class imd(imdb):
  def __init__(self, image_set, year, dist_path=None):
    ...
    self._year = year
    self._image_set = image_set.split('imd2020_')[1]
  ...
  def mask_path_from_index(self, index):
    ...
    for ext in self._image_ext:
      mask_path = os.path.join(index + '_mask' + ext)
  ...
  def image_path_from_index(self, index):
    ...
    for ext in self._image_ext:
      #image_path = os.path.join('/home-3/pengzhou@umd.edu/work/xintong/medifor/portrait/test_data',
                              #index + ext)
      image_path = os.path.join(index + ext)
  ...
  def _load_image_set_index(self):
    ...
    image_set_file = os.path.join('/data/imd20', self._image_set + '.txt')
